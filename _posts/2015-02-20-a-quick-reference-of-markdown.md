...
This post lists out some frequently used formatting elements in Markdown. It is used as a quick reference for my daily writing. Some of the examples I used here come [Markdown Tutorial](http://markdowntutorial.com/){:target="_blank"}, and I highly encourage you to take 5 minutes to learn how to write in markdown. 
